...
mod tests {
    ...
    fn test_logout_clears_api_key() {
        ...
        config.api_key = Some("rico_test_key".to_string());
        
        // Call logout
        let result = super::super::logout(&mut config);
        
        assert!(result.is_ok(), "Logout should succeed");
        assert_eq!(config.api_key, None, "API key should be cleared after logout");
    ...
    fn test_logout_when_not_logged_in() {
        ...
        assert!(result.is_ok(), "Logout should succeed even when not logged in");
    ...
    fn test_api_key_abbreviation() {
        let test_cases = vec![
            ...
            ("rico_Lg47wQANfgs_LdTNgNXvRMGXmAS2wfUNrJUYXpe2PaWRy", "rico_Lg47wQA..."),  // Long key abbreviated
    ...
    fn test_env_var_handling() {
        ...
        assert_eq!(env::var("RICOCHET_SERVER").unwrap(), "https://env.server.com");
    ...
    fn test_api_key_response_deserialization() {
        ...
        assert_eq!(response.expires_at, Some("2024-03-18T20:00:00Z".to_string()));
